...
function [H, rhs, time] = interpolation_system_rhs(geometry, low_rank_data, problem_data)
% interpolation_system_RHS
...
%
% [H, rhs, time] = ...
% interpolation_system_RHS(geometry, low_rank_data, problem_data)
%
% Purpose
% -------
